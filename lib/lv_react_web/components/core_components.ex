defmodule LvReactWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LvReactWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LvReactWeb.Gettext, "errors", msg, opts)
    end
  end
